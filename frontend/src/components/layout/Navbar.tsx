        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-y-0 right-0 w-[85vw] max-w-[320px] bg-[#030303] shadow-[0_0_50px_rgba(0,0,0,0.8)] z-[80] md:hidden flex flex-col border-l border-white/[0.08] overflow-hidden"
            >
